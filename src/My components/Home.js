    ...
    <>
      ...
      <div class="site-wrap">
        ...
        <div class="site-blocks-cover her1">
          <div class="container">
            <marquee className="text-light">Please <mark className='icon-phone2 ' >+919541802864</mark>  for any queries related to medicine intake or sale.</marquee>
            <div class="row">
              <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
                <div class="site-block-cover-content text-center">
                  ...
                  <p>
                    <Link to="Find" class="btn btn-primary px-5 py-3">Find medicine Availability</Link>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row align-items-stretch section-overlap">
              <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="banner-wrap bg-primary h-100">
                  <p class="h-100">
                    <h5 className='text-light'>All Kinds of Medicine<br /> Available </h5>
                    <p className='text-light'>
                      Please contact us on <span  className='icon-phone2'></span>+919541802864.
              ...
              <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="banner-wrap h-100">
                  <p class="h-100 text-primary">
                    <h5>Timing<br /> 8:00 am - 7:00 pm</h5>
                    <p>
                      Our store is remains open for all days of week. Except first three days on Eid eve.
              ...
              <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="banner-wrap bg-warning h-100">
                  <Link to="Find" class="h-100">
                    ...
                    <p className='text-light'>
                      Please reach us at sheikh medical store Janglat mandi Anantnag.<span className='icon-phone2'></span>+919541802864.
        ...
        <div class="site-section">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-lg-4 text-center item mb-4 ">
                ...
                <h3 className='bet text-success'>Betnovate-N</h3>
          ...
          <p>
            <Link to="Find" class="btn btn-primary px-5 py-3">Buy Medicine</Link>
          </p>
