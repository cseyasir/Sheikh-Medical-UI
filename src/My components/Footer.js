            ...
            <div class="container mt-5">
              <div class="row">
                <div class="col-md-8 col-lg-3 mb-4 mb-lg-0">
                  ...
                  <div class="block-2">
                    <h3 class="footer-heading mb-1 text-success">About Us</h3>
              <p className='text-light'>Our shop is one of the oldest chemist shop in entire Janglat mendi area.Lot of peope have been quired.</p>
                ...
                <div class="col-lg-3 mx-auto mb-5 mb-lg-0">
                  <h3 class="footer-heading mb-1 text-success">Quick Links</h3>
                  <ul class="list-unstyled">
                    <li><Link to="/">Home</Link></li>
                    <li><Link to="About">About</Link></li>
                    <li><Link to="Find">Find Medicine Available</Link></li>
                  </ul>
                </div>

                <div class="col-md-6 col-lg-3">
                  <div class="block-5 mb-2">
                    <h3 class="footer-heading mb-1 text-success">Contact Info</h3>
                    <ul class="list-unstyled">
...
></iframe>
                      ...
                      <li class="phone text-light"><a href="tel:+919541802864">+919541802864</a></li>
                      <li class="email text-light"><a href ="mailto:sheikhmedicalstore@gmail.com">sheikhmedicalstore@gmail.com</a></li>
                    </ul>
                  </div>
                </div>
